...
Valid Redirect URIs::
  ...
  Wildcards (\*) are allowed in the protocol, host, port, or path of a URI, i.e. $$http*://host.com, http://*.host.com, http://host.com:808*, http://host.com/*, or http://host.com/region/*/go$$.  This field is used when the exact SAML
